...
DECLARE @rptName varchar(100) = 'Essure English Cases - (Detail)';
DECLARE @rptDesc varchar(500) = 'Essure English Cases - (Detail)';
DECLARE @rptId varchar(50) = 'Essure English Cases';
...
LEFT JOIN  race ON race.id=names.idcodeid AND race.race_id <> 2
WHERE 
